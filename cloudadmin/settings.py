...
parser = ConfigParser()
parser.read(['/etc/cloudadmin/settings.ini', os.path.join(BASE_DIR, 'settings.ini')])
...
LDAP_AUTH_SYNC_USER_RELATIONS =   "cloudadmin.ldap.custom_sync_user_relations"

# Path to a callable that takes a dict of {ldap_field_name: value},
# returning a list of [ldap_search_filter]. The search filters will then be AND'd
# together when creating the final search filter.
LDAP_AUTH_FORMAT_SEARCH_FILTERS = "django_python3_ldap.utils.format_search_filters"
#LDAP_AUTH_FORMAT_SEARCH_FILTERS = "cloudadmin.ldap.custom_format_search_filters"
